...
template<class PR>
    Tensor<2, FloatValue<PR>> setIC2D(std::function<FloatValue<PR>(FloatValue<PR>, FloatValue<PR>)>& phi0, SizeType Nx, SizeType Ny, Array<FloatValue<PR>> spacePointX, Array<FloatValue<PR>> spacePointY)
    {
...
template<class PR>
Tensor<3, FloatValue<PR>> pde_2Dsolver(std::function<FloatValue<PR>(FloatValue<PR>, FloatValue<PR>)>& phi0, std::function<FloatValue<PR>(FloatValue<PR>, FloatValue<PR>, FloatValue<PR>)>& source, Parameter2D<PR>& firstDim, Parameter2D<PR>& secondDim, SizeType Nx, SizeType Ny)
    {
