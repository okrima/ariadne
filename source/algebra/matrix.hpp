    ...
    : public MatrixContainer<Matrix<X>>
{
  ...
  public:
    ...
    template<class... PRS> requires Constructible<X,PRS...> explicit Matrix(SizeType m, SizeType n, PRS... prs) : Matrix(m,n,X(prs...)) { }
    ...
    //! Construct a matrix using initializer lists.
    template<class... PRS> requires Constructible<X,ExactDouble,PRS...> Matrix(InitializerList<InitializerList<double>> lst, PRS... prs);
    ...
    template<class... PRS> requires Constructible<X,PRS...> static Matrix<X> identity(SizeType n, PRS... prs);
    //@}
...
template<class X> template<class... PRS> requires Constructible<X,PRS...> auto
