...
TaylorSeriesBounderIntegrator::TaylorSeriesBounderIntegrator(
        MaximumError err, Sweeper<FloatDP> const& swp, LipschitzConstant lip, Order ord)
    : TaylorSeriesIntegrator(err,swp,lip,ord)
{ }

TaylorSeriesBounderIntegrator::TaylorSeriesBounderIntegrator(
        MaximumError err, Order ord)
    : TaylorSeriesIntegrator(err,ord)
{ }
...
{
    ARIADNE_LOG(3,"TaylorSeriesBounderIntegrator::flow_step(ValidatedVectorMultivariateFunction f, ExactBoxType domx, StepSizeType& hsug)\n");

    Dyadic max_err=Dyadic(this->maximum_error());
    auto deg=this->order();
