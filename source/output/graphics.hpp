...
struct GraphicsProperties {
    GraphicsProperties()
        : dot_radius(1.0), line_style(true), line_width(1.0), line_colour(black), fill_style(true), fill_colour(ariadneorange), is3D(false), isProj(false),isXY(false), isXZ(false), isYZ(false) { }
